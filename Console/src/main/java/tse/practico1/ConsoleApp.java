...
public class ConsoleApp {
    ...
    static {
        try {
            ...
            props.put(Context.SECURITY_CREDENTIALS, "admin1234");
            //ya no se usa ya que uso wildfly-naming-client-jakarta
            //props.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming");
            Context ctx = new InitialContext(props);
            hechosService = (IHechosRemote) ctx.lookup("ejb:/practico1-ejb/HechosService!tse.practico1.service.Interface.IHechosRemote");
